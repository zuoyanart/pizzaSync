...
window.layer = {
    ...
    config: function(options, fn){
        ...
        layer.use('../public/modules/layer/skin/layer.css'.replace('/modules/layer/',''), (options.extend && options.extend.length > 0) ? (function loop(){
...
'function' === typeof define == false ? define(function(){
   ...
   layer.use('../public/modules/layer/skin/layer.css'.replace('/modules/layer/',''));
}();
...
var spaceLayer = new function() {
	...
	_self.iframe = function(width, height, title, src, isparent) {
		...
		$('html').css({'overflow':'hidden',"margin-right": scroolWidth});
	...
	_self.msg = function(options) {
		...
		var options = $.extend(defaults, options);
		if(options.id) {
			options.offset = $(options.id).offset().top + 50 + 'px';
		}
	...
	_self.tipForm = function(obj, dropObj, display) {
		$(obj).on('click', function() {
			var o = $(dropObj), op = $(obj).data('op'), opwhere = $(obj).data('opwhere');
	...
	_self.detail = function(id) {
		...
		_this.hover(function() {
			...
			obj.html(html).css({'display':'block'});
...
var tools = new function() {
    ...
    _self.ajaxGloble = function() {
        var ajaxLoadIndex = '';
        $.ajaxSetup({
            global: false,
            type: "POST",
            dataType: 'json',
            ajaxStart: function() { //发送之前
